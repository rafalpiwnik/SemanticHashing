...
class Ui_TestDialog(object):
    def setupUi(self, TestDialog):
        ...
        self.recall = QtWidgets.QLabel(self.groupBox)
        self.recall.setObjectName("recall")
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.recall)
    ...
    def retranslateUi(self, TestDialog):
        ...
        self.label_2.setText(_translate("TestDialog", "Mean recall"))
        self.recall.setText(_translate("TestDialog", "---"))
